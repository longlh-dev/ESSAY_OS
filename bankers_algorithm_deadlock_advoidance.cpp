...
using namespace std;
 ...
 // kiem tra dieu kien de cap phat tien trinh (work >= need)
...
// ham kiem tra thuat toan Banker
...
//huy cac gia tri da khoi tao neu select = 0 
